 ...
 * eg: int getX(return x;)A mutator  is a member function that can modify an object void setX(int x){this.x=x;} ]
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		Email em = new Email();  
		em.setSender("balaji@gmail.com");   
		em.setRecipient("natarajan@gmail.com");  
		em.setTitle("CoreJava L1 assignments");  
		em.setBody("Program to implement concepts of inheritance and string concatenation");  
